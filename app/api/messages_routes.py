...
from app.models import db, Friend, Message, User
...
@message_routes.route("/<int:friendId>")
@login_required
def get_messages(friendId):
    all_messages = Message.query.filter(Message.friendId == friendId)
    return {
